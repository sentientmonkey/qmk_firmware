...
[_QW] = { /* Qwerty */
  ...
  {LT(_LW,KC_A),KC_S,    KC_D,    KC_F,    KC_G,   KC_TRNS,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN },
  {SFT_T(KC_Z),KC_X, KC_C,    KC_V,    KC_B,   ALT_T(KC_ENT),  KC_N,    KC_M,    KC_COMM, KC_DOT, SFT_T(KC_SLSH)},
  {LT(_LW,KC_ESC), KC_TAB, KC_LGUI,  KC_LSFT, KC_BSPC, CTL_T(KC_SPC), KC_SPC,  MO(_RS), KC_MINS, KC_QUOT, KC_ENT  }
},
/*
 *  !       @     up     {    }        ||     pgup    7     8     9    *
